...
<div class="grid">
    ...
    <div class="glass-card">
        ...
        <p>Pandawa nomor dua yang memiliki perawakan besar, gagah, tegas, jujur, dan tidak pernah berbahasa krama kepada siapapun (kecuali dewa).</p>
    </div>
    ...
    <div class="glass-card">
        ...
        <h3>Punokawan</h3>
        <p>Terdiri dari Semar, Gareng, Petruk, dan Bagong. Mereka adalah pamomong (pengasuh) para kesatria yang bijaksana dan sering melontarkan humor bermakna.</p>
    </div>
</div>
@endsection
